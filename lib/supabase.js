  ...
  constructor() {
    this.tables = {
      ...
      shopkeeper_customers: [
        { id: 'sc-uuid-1', shopkeeper_id: 'sk-uuid-1', customer_id: 'c-uuid-1', outstanding_balance: 100, status: 'active', last_activity_at: new Date().toISOString() }
      ],
      transactions: [],
      nudges: [],
      repayment_patterns: []
    ...
    const builder = {
      ...
      insert(rowOrRows) {
        ...
        const inserted = rows.map(r => {
          const newRow = { id: `inserted-uuid-${Math.random().toString(36).substr(2, 9)}`, ...r }
